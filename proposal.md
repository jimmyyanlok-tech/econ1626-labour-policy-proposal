...
**From:** Policy Analyst  
**Date:** May 2026  
**Subject:** Policy response to artificial intelligence and labour market change  
...
AI affects the labour market through four main economic channels: task substitution, task augmentation, wage dispersion and industry concentration. First, AI can substitute for tasks that are repetitive, rules-based or information-processing intensive. This does not mean that all exposed jobs disappear. Instead, occupations are likely to be redesigned as some tasks are automated while others remain human-led. For example, administrative workers, customer-service staff, junior analysts and clerical employees may spend less time on routine documentation, scheduling or information retrieval, but more time on judgement, relationship management and problem-solving.

Second, AI can augment workers by raising productivity. Employees who can use AI tools effectively may complete analysis, writing, coding or service tasks faster and at higher quality. This can increase firm output and create demand for new roles in AI governance, data management, cybersecurity, compliance and digital transformation. However, these gains depend on workers having access to training and on firms redesigning work in ways that complement human skills rather than simply reducing labour costs.

Third, AI may increase wage inequality. Workers with high digital skills, strong problem-solving ability and access to AI-complementary occupations may receive wage gains, while workers in exposed routine roles may face weaker bargaining power, lower hours or displacement risk. The IMF argues that AI exposure is spread across income groups, but the benefits of AI may be stronger for higher-income workers where complementarity is greater (Cazzaniga et al. 2024). This creates a risk that productivity gains flow mainly to skilled workers, managers and capital owners.
